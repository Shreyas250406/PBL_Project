  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>Lost Items</h1>
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>{pagination.total} items reported lost</p>
        </div>
      </div>
