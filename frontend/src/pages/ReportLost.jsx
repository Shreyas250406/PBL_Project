  ...
  if (success) {
    return (
      <div className="max-w-lg mx-auto px-4 py-20 text-center animate-scale-in">
        ...
        <h2 className="text-2xl font-bold mb-3" style={{ color: '#111827' }}>Item Reported!</h2>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: '#111827' }}>Report Lost Item</h1>
          <p className="text-sm" style={{ color: '#6b7280' }}>Fill in the details to help find your item</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-2xl p-6 sm:p-8 space-y-6"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: '#374151' }}>
                <Calendar className="w-3.5 h-3.5 inline mr-1.5" /> Date Lost *
              </label>
              <input type="date" required value={form.date}
                onChange={(e) => setForm({ ...form, date: e.target.value })}
                className="w-full px-4 py-3 rounded-xl text-sm outline-none"
                style={inputStyle} id="item-date" />
            </div>
          </div>
