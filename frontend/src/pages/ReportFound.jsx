    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center animate-scale-in">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6"
          ...
          <HandHeart className="w-10 h-10" style={{ color: 'var(--success)' }} />
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 animate-fade-in">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>Report Found Item</h1>
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Help someone get their item back</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="glass rounded-2xl p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)' }}>
                <Calendar className="w-3.5 h-3.5 inline mr-1" /> Date Found *
              </label>
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)' }}>
              <MapPin className="w-3.5 h-3.5 inline mr-1" /> Found Location *
            </label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="tel" value={form.contactPhone}
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm outline-none"
                style={inputStyle} id="found-contact-phone" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)' }}>
              ...
              <input type="email" value={form.contactEmail}
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm outline-none"
                style={inputStyle} id="found-contact-email" />
            </div>
          </div>
        </div>
